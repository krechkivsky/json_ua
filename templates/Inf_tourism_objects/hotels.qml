...
<qgis labelsEnabled="0" autoRefreshTime="0" simplifyAlgorithm="0" simplifyMaxScale="1" minScale="0" simplifyLocal="1" readOnly="0" version="3.34.15-Prizren" simplifyDrawingTol="1" maxScale="0" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" autoRefreshMode="Disabled" simplifyDrawingHints="0">
  <flags>
  ...
  <elevation binding="Centroid" symbology="Line" type="IndividualFeatures" clamping="Terrain" showMarkerSymbolInSurfacePlots="0" respectLayerSymbol="1" zoffset="0" zscale="1" extrusionEnabled="0" extrusion="0">
    ...
    <profileLineSymbol>
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="line" name="" alpha="1">
        ...
        <layer locked="0" id="{6949e533-6944-4ebb-83c3-0d61968a611f}" pass="0" class="SimpleLine" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="fill" name="" alpha="1">
        ...
        <layer locked="0" id="{b1aeca2c-981c-4402-9b1c-275cd7b7e391}" pass="0" class="SimpleFill" enabled="1">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="" alpha="1">
        ...
        <layer locked="0" id="{c0a0fe09-6340-41dd-994c-d4f59a5f6110}" pass="0" class="SimpleMarker" enabled="1">
          <Option type="Map">
  ...
  <renderer-v2 type="RuleRenderer" forceraster="0" referencescale="-1" symbollevels="0" enableorderby="0">
    <rules key="{9664c2cf-13e7-49c1-91a0-2f6a28aa92ac}">
      <rule label="готелі, мотелі, хостели існуючі" symbol="0" filter="type in (1,2,3) and &quot;state&quot; in (1,2,3,4,5,6,7,13)" key="{75ae3e49-c180-4c07-a26a-218c41ed842d}"/>
      <rule label="база відпочинку, пансіонат існуюча" symbol="1" filter="type in (4,5,6) and &quot;state&quot; in (1,2,3,4,5,6,7,13)" key="{5ba91ef2-0aa9-4455-ab77-26a086413e02}"/>
      <rule label="туристична база/комплекс існуюча" symbol="2" filter="type in (7,8,9) and &quot;state&quot; in (1,2,3,4,5,6,7,13)" key="{cf4b0c72-73be-42e9-a3d0-943a68b99342}"/>
      <rule label="дитячий заклад оздоровлення та відпочинку (дитячий оздоровчий табір) існуючий" symbol="3" filter="type=10 and &quot;state&quot; in (1,2,3,4,5,6,7,13)" key="{f4d2c32f-10c7-4f78-b244-434f1e8141b9}"/>
      <rule label="агросадиба існуюча" symbol="4" filter="type=11 and &quot;state&quot; in (1,2,3,4,5,6,7,13)" key="{9fc32706-0c15-47d7-a70e-9b4a2647baf1}"/>
      <rule label="кемпінг існуючий" symbol="5" filter="type=12 and &quot;state&quot; in (1,2,3,4,5,6,7,13)" key="{fc694b18-c3ce-4814-ad52-c141c958c6b6}"/>
      <rule label="будинок рибалки існуючий" symbol="6" filter="type=13 and &quot;state&quot; in (1,2,3,4,5,6,7,13)" key="{1a70d2a5-ad75-4cad-b75d-36b74a05bd82}"/>
      <rule label="будинок мисливця існуючий" symbol="7" filter="type=14 and &quot;state&quot; in (1,2,3,4,5,6,7,13)" key="{56051cda-e3d3-4eeb-93d9-56a1e2f0c39b}"/>
      <rule label="туристичний притулок існуючий" symbol="8" filter="type=15 and &quot;state&quot; in (1,2,3,4,5,6,7,13)" key="{65ca4e6e-7948-46b8-be0d-be42f297ea18}"/>
      <rule label="готелі, мотелі, хостели проектні" symbol="9" filter="type in (1,2,3) and &quot;state&quot; in (8,9,10,11,12)" key="{3eaf7955-fa24-42ab-a9d5-84a05634aa03}"/>
      <rule label="база відпочинку, пансіонат проектна" symbol="10" filter="type in (4,5,6) and &quot;state&quot; in (8,9,10,11,12)" key="{0c2f82a0-976c-4a5d-aaee-a69522cd6dd1}"/>
      <rule label="туристична база/комплекс проектна" symbol="11" filter="type in (7,8,9) and &quot;state&quot; in (8,9,10,11,12)" key="{cd87d011-3e20-40d3-a462-b2b0d4192bb3}"/>
      <rule label="дитячий заклад оздоровлення та відпочинку (дитячий оздоровчий табір) проектний" symbol="12" filter="type=10 and &quot;state&quot; in (8,9,10,11,12)" key="{30746515-29c7-4ab7-b17a-650ca4a0409d}"/>
      <rule label="агросадиба проектна" symbol="13" filter="type=11 and &quot;state&quot; in (8,9,10,11,12)" key="{99a69921-f7e1-4097-9569-bfcb16480842}"/>
      <rule label="кемпінг проектний" symbol="14" filter="type=12 and &quot;state&quot; in (8,9,10,11,12)" key="{5ef2948c-6637-49fb-81aa-2e8a992b8bb5}"/>
      <rule label="будинок рибалки проектний" symbol="15" filter="type=13 and &quot;state&quot; in (8,9,10,11,12)" key="{74ba5dd9-4a93-4999-8380-f4e3f0141f29}"/>
      <rule label="будинок мисливця проектний" symbol="16" filter="type=14 and &quot;state&quot; in (8,9,10,11,12)" key="{39fa5940-89f0-4820-b264-d93931fd7824}"/>
      <rule label="туристичний притулок проектний" symbol="17" filter="type=15 and &quot;state&quot; in (8,9,10,11,12)" key="{b55d815e-db78-4cdf-a24a-5fa774512e3e}"/>
      <rule label="інші" symbol="18" filter="ELSE" key="{60d377d0-39d8-4726-999e-75994736f5c2}"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="0" alpha="0.835">
        ...
        <layer locked="0" id="{9e542931-2c83-4ea4-8320-b5e95746fb4b}" pass="0" class="FilledMarker" enabled="1">
          <Option type="Map">
          ...
          <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="fill" name="@0@0" alpha="1">
            ...
            <layer locked="0" id="{878e8852-711c-400a-89b1-313da0ed397a}" pass="0" class="SimpleFill" enabled="1">
              <Option type="Map">
                <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
                <Option value="249,249,249,255" type="QString" name="color"/>
                ...
                <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
                <Option value="MM" type="QString" name="offset_unit"/>
                <Option value="4,0,0,255" type="QString" name="outline_color"/>
                <Option value="solid" type="QString" name="outline_style"/>
        ...
        <layer locked="0" id="{07da1f5f-13a2-4e91-8202-02adf550afe7}" pass="0" class="FontMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="Н" type="QString" name="chr"/>
            <Option value="252,0,4,255" type="QString" name="color"/>
            ...
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
            <Option value="249,2,2,255" type="QString" name="outline_color"/>
      ...
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="1" alpha="0.835">
        ...
        <layer locked="0" id="{3419125e-f70f-4b8d-b707-f989bf831486}" pass="0" class="FilledMarker" enabled="1">
          <Option type="Map">
            <Option value="90" type="QString" name="angle"/>
            <Option value="249,249,249,255" type="QString" name="color"/>
            <Option value="1" type="QString" name="horizontal_anchor_point"/>
          ...
          <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="fill" name="@1@0" alpha="1">
            ...
            <layer locked="0" id="{e73ed7cb-2401-4c0c-bc54-816ce8ada800}" pass="0" class="SimpleFill" enabled="1">
              <Option type="Map">
                <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
                <Option value="249,249,249,255" type="QString" name="color"/>
                <Option value="round" type="QString" name="joinstyle"/>
      ...
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="10" alpha="0.835">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{df063705-a103-4a5f-97e6-b6b9868e9fac}" pass="0" class="FilledMarker" enabled="1">
          <Option type="Map">
            <Option value="90" type="QString" name="angle"/>
            <Option value="249,249,249,255" type="QString" name="color"/>
            <Option value="1" type="QString" name="horizontal_anchor_point"/>
          ...
          <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="fill" name="@10@0" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer locked="0" id="{66cc6768-d727-4ee9-85e0-2b89138a6a1a}" pass="0" class="SimpleFill" enabled="1">
              <Option type="Map">
                <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
                <Option value="249,249,249,255" type="QString" name="color"/>
                <Option value="round" type="QString" name="joinstyle"/>
        ...
        <layer locked="0" id="{3b35cd33-e766-4b94-a66d-274c720432aa}" pass="0" class="RasterMarker" enabled="1">
          <Option type="Map">
            <Option value="1" type="QString" name="alpha"/>
            <Option value="0" type="QString" name="angle"/>
            <Option value="0" type="QString" name="fixedAspectRatio"/>
      ...
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="11" alpha="0.835">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{a1c5ce55-66b6-4663-92e4-f4c0a9ee3a5b}" pass="0" class="FilledMarker" enabled="1">
          <Option type="Map">
            <Option value="90" type="QString" name="angle"/>
          ...
          <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="fill" name="@11@0" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer locked="0" id="{cc1610ce-eada-4b69-903d-e342989d6879}" pass="0" class="SimpleFill" enabled="1">
              <Option type="Map">
                <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
                <Option value="255,0,0,255" type="QString" name="color"/>
                <Option value="round" type="QString" name="joinstyle"/>
        ...
        <layer locked="0" id="{8cd73f44-da95-4ca9-ac75-b995451cb92e}" pass="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
        ...
        <layer locked="0" id="{d9d980b3-3331-4529-959e-bd5f351a7b18}" pass="0" class="SimpleMarker" enabled="1">
          <Option type="Map">
            <Option value="90" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="255,0,0,255" type="QString" name="color"/>
            ...
            <Option value="2.79999999999999982,0" type="QString" name="offset"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
            <Option value="255,255,255,255" type="QString" name="outline_color"/>
            <Option value="solid" type="QString" name="outline_style"/>
        ...
        <layer locked="0" id="{78db9d41-731a-4686-b593-fc22826d6eae}" pass="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="255,255,255,255" type="QString" name="color"/>
            <Option value="0" type="QString" name="fixedAspectRatio"/>
            ...
            <Option value="0.59999999999999998,-2.39999999999999991" type="QString" name="offset"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
            <Option value="255,255,255,255" type="QString" name="outline_color"/>
        ...
        <layer locked="0" id="{1aa4c031-f912-4f4e-af60-1b65705339c8}" pass="0" class="SimpleMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="255,0,0,255" type="QString" name="color"/>
      ...
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="12" alpha="0.835">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{70be360d-fd40-4c29-9111-83bf3f11d9c6}" pass="0" class="FilledMarker" enabled="1">
          <Option type="Map">
            <Option value="90" type="QString" name="angle"/>
            <Option value="249,249,249,255" type="QString" name="color"/>
            <Option value="1" type="QString" name="horizontal_anchor_point"/>
          ...
          <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="fill" name="@12@0" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer locked="0" id="{c5f41566-39f4-4682-bd11-9706efb3dc1b}" pass="0" class="SimpleFill" enabled="1">
              <Option type="Map">
                <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
                <Option value="249,249,249,255" type="QString" name="color"/>
                <Option value="round" type="QString" name="joinstyle"/>
        ...
        <layer locked="0" id="{6766899c-805f-412a-a3d2-eed382f47838}" pass="0" class="RasterMarker" enabled="1">
          <Option type="Map">
            <Option value="1" type="QString" name="alpha"/>
            <Option value="0" type="QString" name="angle"/>
            <Option value="0" type="QString" name="fixedAspectRatio"/>
      ...
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="13" alpha="0.835">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{4146282f-4bc8-49ba-ab17-f98d5b43a700}" pass="0" class="EllipseMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="255,255,255,255" type="QString" name="color"/>
            ...
            <Option value="3x:0,0,0,0,0,0" type="QString" name="size_map_unit_scale"/>
            <Option value="MM" type="QString" name="size_unit"/>
            <Option value="9" type="QString" name="symbol_height"/>
            ...
            <Option value="rectangle" type="QString" name="symbol_name"/>
            <Option value="9" type="QString" name="symbol_width"/>
        ...
        <layer locked="0" id="{5a767a7f-56b4-43ea-9fd6-f4839168531a}" pass="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
      ...
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="14" alpha="0.835">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{6ac6f4b6-460f-4f7e-bdfa-1ab8d83e3665}" pass="0" class="FilledMarker" enabled="1">
          <Option type="Map">
            <Option value="90" type="QString" name="angle"/>
            <Option value="249,249,249,255" type="QString" name="color"/>
            <Option value="1" type="QString" name="horizontal_anchor_point"/>
          ...
          <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="fill" name="@14@0" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer locked="0" id="{b8636bd7-21c8-41f4-8685-e3c92eebfbe4}" pass="0" class="SimpleFill" enabled="1">
              <Option type="Map">
                <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
                <Option value="249,249,249,255" type="QString" name="color"/>
                <Option value="round" type="QString" name="joinstyle"/>
        ...
        <layer locked="0" id="{93ca07dc-6048-4ff4-b524-bf9669e96fa4}" pass="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="3,0,0,255" type="QString" name="color"/>
            <Option value="0" type="QString" name="fixedAspectRatio"/>
            <Option value="1" type="QString" name="horizontal_anchor_point"/>
            ...
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
            <Option value="2,0,0,255" type="QString" name="outline_color"/>
            <Option value="0.3" type="QString" name="outline_width"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="outline_width_map_unit_scale"/>
            <Option value="MM" type="QString" name="outline_width_unit"/>
            <Option name="parameters"/>
      ...
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="15" alpha="0.835">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{741f4a97-14ab-4ca2-9956-bb5e6366a085}" pass="0" class="EllipseMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="255,255,255,255" type="QString" name="color"/>
        ...
        <layer locked="0" id="{91c86c8a-d0f1-4581-b5d8-e03dee4bc2a4}" pass="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="0,0,0,255" type="QString" name="color"/>
            <Option value="0" type="QString" name="fixedAspectRatio"/>
        ...
        <layer locked="0" id="{65a9a76a-d62f-4743-9f79-1029d5e73800}" pass="0" class="SimpleMarker" enabled="1">
          <Option type="Map">
      ...
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="16" alpha="0.835">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{6bbbf6b1-a6a4-4fb4-90ac-012b9a6679f4}" pass="0" class="EllipseMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="255,255,255,255" type="QString" name="color"/>
        ...
        <layer locked="0" id="{795c114c-fbae-4660-a86c-6579e8d2f8af}" pass="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="0,0,0,255" type="QString" name="color"/>
            <Option value="0" type="QString" name="fixedAspectRatio"/>
            ...
            <Option name="parameters"/>
            <Option value="diameter" type="QString" name="scale_method"/>
            <Option value="6.5" type="QString" name="size"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="size_map_unit_scale"/>
            <Option value="MM" type="QString" name="size_unit"/>
            <Option value="1" type="QString" name="vertical_anchor_point"/>
          </Option>
        ...
        <layer locked="0" id="{cfcc2101-7f8b-4bc7-893a-cac475a5cb1e}" pass="0" class="SimpleMarker" enabled="1">
          <Option type="Map">
            <Option value="270" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="255,0,0,255" type="QString" name="color"/>
      ...
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="17" alpha="0.835">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{893edb7d-32b5-4cd7-81cb-38157931455a}" pass="0" class="FilledMarker" enabled="1">
          <Option type="Map">
            <Option value="90" type="QString" name="angle"/>
            <Option value="249,249,249,255" type="QString" name="color"/>
            <Option value="1" type="QString" name="horizontal_anchor_point"/>
          ...
          <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="fill" name="@17@0" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer locked="0" id="{0d88f66a-9cf4-4768-b66c-75e35988eaea}" pass="0" class="SimpleFill" enabled="1">
              <Option type="Map">
                <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
                <Option value="249,249,249,255" type="QString" name="color"/>
                <Option value="round" type="QString" name="joinstyle"/>
                ...
                <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
                <Option value="MM" type="QString" name="offset_unit"/>
                <Option value="249,0,0,255" type="QString" name="outline_color"/>
                <Option value="solid" type="QString" name="outline_style"/>
                <Option value="1" type="QString" name="outline_width"/>
                <Option value="MM" type="QString" name="outline_width_unit"/>
                <Option value="solid" type="QString" name="style"/>
        ...
        <layer locked="0" id="{d1a4e333-dba2-423d-a3f6-281ac393f666}" pass="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="3,0,0,255" type="QString" name="color"/>
            <Option value="0" type="QString" name="fixedAspectRatio"/>
      ...
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="18" alpha="0.835">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{f57eb40e-e4b4-4787-ac42-2e21cc61e952}" pass="0" class="EllipseMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="255,255,255,255" type="QString" name="color"/>
      ...
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="2" alpha="0.835">
        ...
        <layer locked="0" id="{eb48a746-d279-416d-abb7-1885a5d8f9b1}" pass="0" class="FilledMarker" enabled="1">
          <Option type="Map">
            <Option value="90" type="QString" name="angle"/>
            <Option value="255,0,0,255" type="QString" name="color"/>
            <Option value="1" type="QString" name="horizontal_anchor_point"/>
          ...
          <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="fill" name="@2@0" alpha="1">
            ...
            <layer locked="0" id="{f15a541f-240e-4e9e-8d86-54c98fffb5e2}" pass="0" class="SimpleFill" enabled="1">
              <Option type="Map">
                <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
                <Option value="255,0,0,255" type="QString" name="color"/>
                <Option value="round" type="QString" name="joinstyle"/>
        ...
        <layer locked="0" id="{9a5c3252-60a4-4589-9f66-960c5c26cc4f}" pass="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="255,255,255,255" type="QString" name="color"/>
            <Option value="0" type="QString" name="fixedAspectRatio"/>
        ...
        <layer locked="0" id="{d4b15125-39a3-4d9c-a5e6-76c1765d5244}" pass="0" class="SimpleMarker" enabled="1">
          <Option type="Map">
            <Option value="90" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="255,0,0,255" type="QString" name="color"/>
        ...
        <layer locked="0" id="{8cfc4521-eef4-4262-859c-c313ce124882}" pass="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="255,255,255,255" type="QString" name="color"/>
            <Option value="0" type="QString" name="fixedAspectRatio"/>
        ...
        <layer locked="0" id="{3bfed105-255f-47f5-9352-f074732e092b}" pass="0" class="SimpleMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="255,0,0,255" type="QString" name="color"/>
      ...
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="3" alpha="0.835">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{91ae78df-5cb0-413f-9d78-9f4aee849c7b}" pass="0" class="FilledMarker" enabled="1">
          <Option type="Map">
            <Option value="90" type="QString" name="angle"/>
            <Option value="249,249,249,255" type="QString" name="color"/>
            <Option value="1" type="QString" name="horizontal_anchor_point"/>
          ...
          <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="fill" name="@3@0" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer locked="0" id="{e1e09f6d-662b-4c5e-9989-9316a5e424dd}" pass="0" class="SimpleFill" enabled="1">
              <Option type="Map">
                <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
                <Option value="249,249,249,255" type="QString" name="color"/>
                <Option value="round" type="QString" name="joinstyle"/>
                ...
                <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
                <Option value="MM" type="QString" name="offset_unit"/>
                <Option value="237,170,141,255" type="QString" name="outline_color"/>
                <Option value="solid" type="QString" name="outline_style"/>
                <Option value="1" type="QString" name="outline_width"/>
                <Option value="MM" type="QString" name="outline_width_unit"/>
                <Option value="solid" type="QString" name="style"/>
        ...
        <layer locked="0" id="{72ac03b0-349b-4735-b494-43e2b92ab30f}" pass="0" class="RasterMarker" enabled="1">
          <Option type="Map">
            <Option value="1" type="QString" name="alpha"/>
            <Option value="0" type="QString" name="angle"/>
            <Option value="0" type="QString" name="fixedAspectRatio"/>
      ...
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="4" alpha="0.835">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{23a8de6b-78dd-44fd-8e69-39ca8dcf57df}" pass="0" class="EllipseMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="255,255,255,255" type="QString" name="color"/>
        ...
        <layer locked="0" id="{af3c6295-793e-4336-8dc7-a1d985e3891a}" pass="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="0,0,0,255" type="QString" name="color"/>
            <Option value="0" type="QString" name="fixedAspectRatio"/>
      ...
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="5" alpha="0.835">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{5acb8f32-9834-49f7-bf56-4ac441dafbc5}" pass="0" class="FilledMarker" enabled="1">
          <Option type="Map">
            <Option value="90" type="QString" name="angle"/>
            <Option value="249,249,249,255" type="QString" name="color"/>
            <Option value="1" type="QString" name="horizontal_anchor_point"/>
          ...
          <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="fill" name="@5@0" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer locked="0" id="{51417e6b-3033-4414-810a-1bdf42755d72}" pass="0" class="SimpleFill" enabled="1">
              <Option type="Map">
                <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
                <Option value="249,249,249,255" type="QString" name="color"/>
                <Option value="round" type="QString" name="joinstyle"/>
        ...
        <layer locked="0" id="{e1c5cef6-9693-473c-84fd-9c6cbcb6b068}" pass="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="3,0,0,255" type="QString" name="color"/>
            <Option value="0" type="QString" name="fixedAspectRatio"/>
      ...
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="6" alpha="0.835">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{200ac8e5-27f1-44d0-8397-13d7e2e82d1a}" pass="0" class="EllipseMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="255,255,255,255" type="QString" name="color"/>
            ...
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
            <Option value="24,0,0,255" type="QString" name="outline_color"/>
            <Option value="solid" type="QString" name="outline_style"/>
            <Option value="1" type="QString" name="outline_width"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="outline_width_map_unit_scale"/>
            <Option value="MM" type="QString" name="outline_width_unit"/>
        ...
        <layer locked="0" id="{b8bfcc3c-b1d5-4701-aff5-84e3a65e5b33}" pass="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="0,0,0,255" type="QString" name="color"/>
            <Option value="0" type="QString" name="fixedAspectRatio"/>
        ...
        <layer locked="0" id="{2feb022b-866c-40e3-a2cb-5f74f1b52147}" pass="0" class="SimpleMarker" enabled="1">
          <Option type="Map">
            <Option value="270" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="255,0,0,255" type="QString" name="color"/>
      ...
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="7" alpha="0.835">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{ca486edb-c517-49ab-a8da-37e124194709}" pass="0" class="EllipseMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="255,255,255,255" type="QString" name="color"/>
        ...
        <layer locked="0" id="{9d74835b-bc98-4f34-9444-cee3dfcdeee0}" pass="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="0,0,0,255" type="QString" name="color"/>
            <Option value="0" type="QString" name="fixedAspectRatio"/>
        ...
        <layer locked="0" id="{71b19405-1bb8-40ef-858e-895fef933642}" pass="0" class="SimpleMarker" enabled="1">
          <Option type="Map">
            <Option value="270" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="255,0,0,255" type="QString" name="color"/>
      ...
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="8" alpha="0.835">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{c9cea4e5-3ed7-4788-8f1c-666dfc4241c8}" pass="0" class="FilledMarker" enabled="1">
          <Option type="Map">
            <Option value="90" type="QString" name="angle"/>
            <Option value="249,249,249,255" type="QString" name="color"/>
            <Option value="1" type="QString" name="horizontal_anchor_point"/>
          ...
          <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="fill" name="@8@0" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer locked="0" id="{bdb2f457-a0f6-4668-bbf5-b18ef82b4263}" pass="0" class="SimpleFill" enabled="1">
              <Option type="Map">
                <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
                <Option value="249,249,249,255" type="QString" name="color"/>
                <Option value="round" type="QString" name="joinstyle"/>
                ...
                <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
                <Option value="MM" type="QString" name="offset_unit"/>
                <Option value="3,0,0,255" type="QString" name="outline_color"/>
                <Option value="solid" type="QString" name="outline_style"/>
                <Option value="1" type="QString" name="outline_width"/>
                <Option value="MM" type="QString" name="outline_width_unit"/>
                <Option value="solid" type="QString" name="style"/>
        ...
        <layer locked="0" id="{69cc4f03-a1db-421a-800e-b9a79f1d0ffd}" pass="0" class="SvgMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="3,0,0,255" type="QString" name="color"/>
            <Option value="0" type="QString" name="fixedAspectRatio"/>
      ...
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="9" alpha="0.835">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{4d9d2759-efcd-4ca9-8041-f80fa836fed9}" pass="0" class="FilledMarker" enabled="1">
          <Option type="Map">
            <Option value="90" type="QString" name="angle"/>
            <Option value="249,249,249,255" type="QString" name="color"/>
            <Option value="1" type="QString" name="horizontal_anchor_point"/>
          ...
          <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="fill" name="@9@0" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer locked="0" id="{645f7c69-8d68-4318-a072-087300404e65}" pass="0" class="SimpleFill" enabled="1">
              <Option type="Map">
                <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
                <Option value="249,249,249,255" type="QString" name="color"/>
                <Option value="round" type="QString" name="joinstyle"/>
        ...
        <layer locked="0" id="{c0d74893-0c4f-44e2-9204-d086f2fbefed}" pass="0" class="FontMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="Н" type="QString" name="chr"/>
            <Option value="252,0,4,255" type="QString" name="color"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="marker" name="" alpha="1">
        ...
        <layer locked="0" id="{a8f1b6da-692b-493c-a53d-6c97fc3dfd46}" pass="0" class="SimpleMarker" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="255,0,0,255" type="QString" name="color"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory lineSizeType="MM" minimumSize="0" backgroundAlpha="255" sizeScale="3x:0,0,0,0,0,0" penWidth="0" penAlpha="255" barWidth="5" enabled="0" penColor="#000000" opacity="1" direction="0" spacing="5" scaleBasedVisibility="0" showAxis="1" spacingUnitScale="3x:0,0,0,0,0,0" diagramOrientation="Up" maxScaleDenominator="0" labelPlacementMethod="XHeight" height="15" sizeType="MM" spacingUnit="MM" lineSizeScale="3x:0,0,0,0,0,0" rotationOffset="270" backgroundColor="#ffffff" scaleDependency="Area" minScaleDenominator="0" width="15">
      ...
      <axisSymbol>
        <symbol force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1" type="line" name="" alpha="1">
          ...
          <layer locked="0" id="{a9d43f64-4d9c-4f15-97b6-e592c1622349}" pass="0" class="SimpleLine" enabled="1">
            <Option type="Map">
              <Option value="0" type="QString" name="align_dash_pattern"/>
              <Option value="square" type="QString" name="capstyle"/>
              <Option value="5;2" type="QString" name="customdash"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer horizontalStretch="0" collapsed="0" visibilityExpressionEnabled="0" collapsedExpressionEnabled="0" visibilityExpression="" columnCount="1" type="Tab" collapsedExpression="" groupBox="0" verticalStretch="0" name="тематичні" showLabel="1">
      ...
      <attributeEditorField horizontalStretch="0" index="-1" verticalStretch="0" name="cap_in" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont style="" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" index="-1" verticalStretch="0" name="cap_pr" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont style="" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" index="-1" verticalStretch="0" name="cap_pro" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont style="" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" index="-1" verticalStretch="0" name="cap_ext" showLabel="1">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont style="" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0" underline="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <reuseLastValue>
    <field reuseLastValue="0" name="cap_ext"/>
    <field reuseLastValue="0" name="cap_in"/>
    <field reuseLastValue="0" name="cap_pr"/>
    <field reuseLastValue="0" name="cap_pro"/>
